...
public class sha256__ {
     ...
     */
    private static String toHexString(int block) {
     ...
     */
    private static String toHexString(BigInteger block) {
    ...
    public static void main(String[] args) {
        ...
        for (String string : messages) {
            System.out.println("--------------------------------------------");
            System.out.println("bits    : "+string.length()*8);
            System.out.println("message : "+string);
            BigInteger num = sha256_00698116_00850045.hash(string.toString().getBytes());
            System.out.println("hash    : "+toHexString((num)));
        }
